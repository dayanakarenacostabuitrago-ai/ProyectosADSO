...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-panel-wrap.hidden { display: none; }
        .login-card {
            background: var(--white);
        ...
        .login-card-head h3 { color: #fff; font-size: 1rem; font-weight: 700; margin: 0; }
        .login-card-head small { color: rgba(255,255,255,0.75); font-size: 0.7rem; }
        .login-card-body { padding: 1.2rem 1.4rem 1rem; }
        .lang-bar { display: flex; gap: 0.35rem; margin-bottom: 1rem; }
        .lang-btn {
            flex: 1; text-align: center; font-size: 0.72rem; font-weight: 600;
            padding: 0.28rem 0.5rem; border-radius: 20px;
            border: 1.5px solid var(--border); color: var(--text-dark);
            background: transparent; text-decoration: none; transition: all 0.2s;
        }
        .lang-btn:hover, .lang-btn.active { background: var(--green); color: #fff; border-color: var(--green); }
        .lf-group { margin-bottom: 0.9rem; }
        .lf-group label { display: block; font-size: 0.72rem; font-weight: 600; color: var(--text-dark); margin-bottom: 0.3rem; text-transform: uppercase; letter-spacing: 0.03em; }
        .lf-input-wrap { position: relative; }
        .lf-input-wrap i { position: absolute; left: 0.75rem; top: 50%; transform: translateY(-50%); color: var(--text-light); font-size: 0.78rem; pointer-events: none; }
        .lf-input {
        ...
        .lf-input:focus { border-color: var(--green); box-shadow: 0 0 0 3px rgba(106,158,138,0.12); background: #fff; }
        .btn-ingresar {
            width: 100%; padding: 0.58rem;
            background: var(--green); color: #fff; border: none;
            border-radius: var(--radius-sm); font-family: 'Inter', sans-serif;
            font-size: 0.88rem; font-weight: 700; cursor: pointer;
            transition: all 0.2s; box-shadow: 0 4px 12px rgba(106,158,138,0.3);
            display: flex; align-items: center; justify-content: center; gap: 0.5rem;
        }
        .btn-ingresar:hover { background: var(--green-dark); transform: translateY(-1px); }
        .login-err {
            font-size: 0.78rem; color: #c53030; background: #FFF5F5;
            border: 1px solid #FEB2B2; border-radius: 8px;
            padding: 0.5rem 0.7rem; margin-bottom: 0.8rem;
            display: flex; align-items: center; gap: 0.4rem;
        }
        .login-err.hidden, .hidden { display: none !important; }
        .otp-section { border-top: 1px solid var(--border); padding: 1rem 1.4rem 1.1rem; animation: fadeSlideDown 0.3s ease both; }
        .otp-section.hidden { display: none !important; }
        @keyframes fadeSlideDown { from { opacity: 0; transform: translateY(-8px); } to { opacity: 1; transform: translateY(0); } }
        .otp-hint { font-size: 0.76rem; color: var(--text-mid); text-align: center; margin-bottom: 0.85rem; line-height: 1.5; }
        .otp-hint strong { color: var(--text-dark); }
        .otp-input-big {
            width: 100%; font-size: 1.8rem; font-weight: 700; letter-spacing: 10px;
            text-align: center; border: 2px solid var(--border); border-radius: var(--radius-sm);
            padding: 0.55rem 1rem; color: var(--text-dark); font-family: 'Courier New', monospace;
            background: var(--gray-bg); transition: all 0.2s; outline: none;
        }
        .otp-input-big:focus { border-color: var(--green); box-shadow: 0 0 0 3px rgba(106,158,138,0.12); background: #fff; }
        .otp-timer { text-align: center; font-size: 0.75rem; color: var(--text-light); margin: 0.45rem 0 0.85rem; }
        #otp-countdown { font-weight: 700; color: var(--text-dark); }
        #otp-countdown.urgente { color: #E53E3E; }
        .btn-verificar {
            width: 100%; padding: 0.55rem;
            background: var(--green); color: #fff; border: none;
            border-radius: var(--radius-sm); font-family: 'Inter', sans-serif;
            font-size: 0.85rem; font-weight: 700; cursor: pointer; transition: opacity 0.2s; margin-bottom: 0.55rem;
        }
        .btn-verificar:hover { opacity: 0.88; }
        .btn-verificar:disabled { background: #cbd5e0; cursor: not-allowed; }
        .btn-reenviar-link {
            display: block; text-align: center; font-size: 0.75rem;
            color: var(--green-dark); font-weight: 600; text-decoration: none;
            cursor: pointer; background: transparent; border: none; width: 100%; padding: 0.2rem;
        }
        .btn-reenviar-link:hover { text-decoration: underline; }
        ...
        .btn-hero-primary:hover { background: var(--green-dark); color: #fff; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(26,46,38,0.22); }
        .btn-hero-secondary {
            display: inline-flex;
            align-items: center;
            gap: 0.6rem;
        ...
        .btn-hero-secondary:hover { border-color: var(--green); color: var(--green-dark); }
        .hero-stats-row {
            display: flex;
            align-items: center;
            gap: 2rem;
        ...
        .appt-card .ac-info small { font-size: 0.72rem; color: var(--text-light); }
        .appt-card .ac-link {
            display: block;
            font-size: 0.72rem;
            color: var(--green-dark);
        ...
        .appt-card .ac-link:hover { text-decoration: underline; }
        /* Doctor avatars */
        .doctors-badge {
            position: absolute;
            top: 1.2rem;
        ...
        .doctors-badge .av:first-child { margin-left: 0; }
        .doctors-badge .av img { width: 100%; height: 100%; object-fit: cover; }
        .doctors-badge .av-text { font-size: 0.72rem; font-weight: 700; color: var(--text-dark); }
        .doctors-badge .av-sub { font-size: 0.62rem; color: var(--text-light); }
        ...
        .historial-content .section-tag { color: rgba(255,255,255,0.6); }
        .historial-content .section-title { color: var(--white); }
        .historial-content .section-desc { color: rgba(255,255,255,0.75); max-width: 400px; margin-bottom: 2rem; }
        .historial-cta-row { display: flex; gap: 1rem; }
        .btn-white {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
        ...
        .resumen-card-head span { font-size: 0.85rem; font-weight: 700; color: var(--text-dark); }
        .resumen-card-head small { font-size: 0.72rem; color: var(--green); font-weight: 600; }
        .resumen-vitals {
            display: grid;
            grid-template-columns: 1fr 1fr;
        ...
        .vital-item small { font-size: 0.72rem; color: var(--text-light); }
        .resumen-lab {
        ...
        .resumen-lab div { }
        .resumen-lab strong { display: block; font-size: 0.82rem; font-weight: 700; color: var(--text-dark); }
        .resumen-lab small { font-size: 0.72rem; color: var(--text-light); }
        .btn-pdf {
            background: var(--green);
            color: #fff;
            font-size: 0.72rem;
        ...
        .medicos-section .section-header-row { margin-bottom: 2.5rem; }
        .medicos-grid {
            display: grid;
        ...
        .medico-card:hover { transform: translateY(-4px); box-shadow: var(--shadow-lg); }
        .medico-img {
            width: 100%;
            height: 240px;
            object-fit: cover;
        ...
        .medico-body { padding: 1.1rem 1.2rem; }
        .medico-body h4 { font-size: 0.95rem; font-weight: 700; color: var(--text-dark); margin-bottom: 0.2rem; }
        .medico-body .esp-tag { font-size: 0.78rem; color: var(--text-mid); margin-bottom: 0.8rem; }
        .btn-agendar {
            display: inline-flex;
            align-items: center;
            gap: 0.4rem;
        ...
        .btn-agendar:hover { background: var(--green); color: #fff; }
        .medicos-ver-mas { text-align: center; }
        .btn-ver-todos {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
        ...
        .btn-ver-todos:hover { border-color: var(--green); color: var(--green-dark); }
        ...
        .footer-brand h3 { font-size: 1rem; font-weight: 800; color: var(--text-dark); margin-bottom: 0.6rem; }
        .footer-brand p { font-size: 0.8rem; color: var(--text-light); line-height: 1.6; max-width: 200px; }
        .footer-col h4 { font-size: 0.8rem; font-weight: 700; color: var(--text-dark); margin-bottom: 0.9rem; }
        .footer-col ul { list-style: none; }
        .footer-col ul li { margin-bottom: 0.5rem; }
        .footer-col ul li a { font-size: 0.78rem; color: var(--text-mid); text-decoration: none; transition: color 0.2s; }
        .footer-col ul li a:hover { color: var(--green-dark); }
        .footer-col .contact-info { font-size: 0.78rem; color: var(--text-mid); line-height: 1.8; }
        .footer-bottom {
            border-top: 1px solid var(--border);
            padding-top: 1.2rem;
            display: flex;
        ...
        .footer-bottom small { font-size: 0.75rem; color: var(--text-light); }
        ...
        @media (max-width: 992px) {
            .navbar-main { padding: 0 1.5rem; }
            .nav-links { display: none; }
            .hero-inner, .historial-inner { grid-template-columns: 1fr; gap: 2rem; }
            .esp-grid { grid-template-columns: repeat(2,1fr); }
            .medicos-grid { grid-template-columns: repeat(2,1fr); }
            .footer-grid { grid-template-columns: 1fr 1fr; }
            .hero-section, .especialidades-section, .historial-section, .medicos-section, footer { padding-left: 1.5rem; padding-right: 1.5rem; }
        }
        @media (max-width: 600px) {
            .esp-grid, .medicos-grid { grid-template-columns: 1fr; }
        ...
        <div class="login-card-body" id="loginFormSection">
            <div class="lang-bar">
                <a href="${pageContext.request.contextPath}/login?lang=es"
                   class="lang-btn ${(empty sessionScope.lang || sessionScope.lang=='es') ? 'active' : ''}">&#127464;&#127476; ES</a>
                <a href="${pageContext.request.contextPath}/login?lang=en"
                   class="lang-btn ${sessionScope.lang=='en' ? 'active' : ''}">&#127482;&#127480; EN</a>
                <a href="${pageContext.request.contextPath}/login?lang=it"
                   class="lang-btn ${sessionScope.lang=='it' ? 'active' : ''}">&#127470;&#127481; IT</a>
            </div>
        ...
        <div class="hero-right">
            <div class="hero-img-wrap">
                ...
                <div class="doctors-badge">
                    <div class="av-stack">
                        <div class="av"><img src="https://randomuser.me/api/portraits/women/44.jpg" alt=""></div>
                        <div class="av"><img src="https://randomuser.me/api/portraits/men/32.jpg" alt=""></div>
