    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" style="max-width:900px;">
        <div class="modal-content" style="border:none; border-radius:14px; overflow:hidden;">
            ...
            <div class="modal-body p-0" style="height:75vh; position:relative;">
                <div id="pdfLoading" style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#f7f9f8;z-index:2;">
                    <div class="spinner-border" style="color:var(--green); width:2.5rem; height:2.5rem;" role="status"></div>
                    <p style="margin-top:1rem; color:var(--text-mid); font-size:.9rem;">Cargando comprobante...</p>
                </div>
                <iframe id="iframeComprobante" src="about:blank" style="width:100%; height:100%; border:none;" title="Comprobante PDF"></iframe>
            </div>
...
<script>
    ...
    /* Abrir comprobante en modal usando blob para evitar X-Frame-Options */
    function abrirComprobante(url) {
        ...
        document.getElementById('iframeComprobante').src = 'about:blank';

        // Actualizar link de descarga
        document.getElementById('linkDescarga').href = url;

        // Cargar PDF como blob para evitar restricción X-Frame-Options
        fetch(url, { credentials: 'same-origin' })
            ...
            .then(function(blob) {
                ...
                var iframe = document.getElementById('iframeComprobante');
                iframe.src = _blobUrl;
            ...
            .catch(function(err) {
                document.getElementById('pdfLoading').innerHTML =
                    ...
                    '<p style="margin-top:.8rem;color:#dc2626;font-size:.9rem;">No se pudo cargar el PDF.<br>Usa el botón <b>Descargar PDF</b>.</p>';
            });
    }
